...
public class UserServiceImpl implements UserService {
    ...
    public void add(User user, String smsCode) {
        ...
        String cacheCode = (String) redisTemplate.boundHashOps(CacheKey.SMS).get("sms_" + user.getPhone());
        ...
        System.out.println("手机号：" + user.getPhone() + "密码：" + user.getPassword() + " 验证码：" + smsCode);
