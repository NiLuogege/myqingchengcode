...
public class SkuController {
    ...
    @GetMapping("/putAllToEs")
    public Result putAllToEs() throws IOException {
        skuService.putAllToEs();
        return new Result();
    }

    @GetMapping("/puOneToEs")
    public Result puOneToEs() throws IOException {
        skuService.puOneToEs();
        return new Result();
    }
